 ...
 * <b>Requirements</b>
 * </p><p>
 * The type T is <i>DefaultInsertable</i> into the <i>Container</i> X whose value_type is identical to T if<br/>
 * Given
...
BOOST_concept(DefaultInsertable, (T)(X))
{
    BOOST_CONCEPT_USAGE(DefaultInsertable)
    {
        ...
        std::allocator_traits<__AllocatorType>::construct(alloc_, pointer_);
    }
