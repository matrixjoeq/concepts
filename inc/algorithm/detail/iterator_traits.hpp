...
template <class Iterator>
using __std_iterator_category_t = stl_concept::__detail::__std_iterator_category_t<Iterator>;

/** @brief Alias of stl_concept::__detail::__std_iterator_difference_t */
template <class Iterator>
using __std_iterator_difference_t = stl_concept::__detail::__std_iterator_difference_t<Iterator>;

/** @brief Alias of stl_concept::__detail::__std_iterator_pointer_t */
template <class Iterator>
using __std_iterator_pointer_t = stl_concept::__detail::__std_iterator_pointer_t<Iterator>;

/** @brief Alias of stl_concept::__detail::__std_iterator_reference_t */
template <class Iterator>
using __std_iterator_reference_t = stl_concept::__detail::__std_iterator_reference_t<Iterator>;

/** @brief Alias of stl_concept::__detail::__std_iterator_value_t */
template <class Iterator>
using __std_iterator_value_t = stl_concept::__detail::__std_iterator_value_t<Iterator>;
/// @endcond
