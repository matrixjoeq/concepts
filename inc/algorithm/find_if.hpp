/** @file */
#ifndef __STL_ALGORITHM_FIND_IF_HPP__
#define __STL_ALGORITHM_FIND_IF_HPP__
...
/**
 * @brief Returns the first element in the range [first, last) that predicate p returns true.
 ...
 * @param p - unary predicate which returns ​true for the required element.<br/>
...
#endif  // __STL_ALGORITHM_FIND_IF_HPP__
