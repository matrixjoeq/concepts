...
struct ConceptChecker
{
    ...
    void operator()(T&)
    {
        ...
        BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<_FuncType, _ArgType>));
    }
};
...
void unary_function_check()
{
    ...
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<Functor, ArgType>));

    BOOST_CONCEPT_ASSERT((boost::UnaryFunction<VoidFunctor, VoidType, ArgType>));
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<VoidFunctor, ArgType>));

    BOOST_CONCEPT_ASSERT((boost::UnaryFunction<decltype(std::bind(func, _1)), ReturnType, ArgType>));
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<decltype(std::bind(func, _1)), ArgType>));

    BOOST_CONCEPT_ASSERT((boost::UnaryFunction<decltype(std::bind(void_func, _1)), VoidType, ArgType>));
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<decltype(std::bind(void_func, _1)), ArgType>));

    BOOST_CONCEPT_ASSERT((boost::UnaryFunction<decltype(std::bind(&Func::func, &f, _1)), ReturnType, ArgType>));
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<decltype(std::bind(&Func::func, &f, _1)), ArgType>));

    BOOST_CONCEPT_ASSERT((boost::UnaryFunction<decltype(std::bind(&VoidFunc::void_func, &vf, _1)), VoidType, ArgType>));
    BOOST_CONCEPT_ASSERT((stl_concept::UnaryFunction<decltype(std::bind(&VoidFunc::void_func, &vf, _1)), ArgType>));
